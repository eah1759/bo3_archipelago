CoD.ApShopButton2ListItem = InheritFrom( LUI.UIElement )
CoD.ApShopButton2ListItem.new = function ( menu, controller )
	...
	self:setClass( CoD.ApShopButton2ListItem )
	self.id = "ApShopButton2ListItem"
