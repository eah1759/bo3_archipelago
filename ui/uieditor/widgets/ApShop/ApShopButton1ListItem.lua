CoD.ApShopButton1ListItem = InheritFrom( LUI.UIElement )
CoD.ApShopButton1ListItem.new = function ( menu, controller )
	...
	self:setClass( CoD.ApShopButton1ListItem )
	self.id = "ApShopButton1ListItem"
