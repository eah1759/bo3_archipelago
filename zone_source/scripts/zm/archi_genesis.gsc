...
{
    // The wisp setup is a pipebomb :)

    level.ap_player_wisps = Array(0,0,0,0);
    for(i = 0; i < 4; i++)
    {
        level thread _track_player_wisps(i);
    }
    level thread _track_wisp("wisp_abcd");
    level thread _track_wisp("wisp_shad");
}
