...
function player_take_piece( pieceSpawn, is_archipelago )
{
	...
	{
		// Not Archipelago, just despawn piece and send event instead
		pieceSpawn piece_unspawn();
		archi_core::send_location(ap_location);
	}
}
...
//	self is a player
function player_get_craftable_piece( str_craftable, str_piece, is_archipelago )
{
	pieceSpawn = get_craftable_piece( str_craftable, str_piece );

	if ( isdefined( pieceSpawn ) )
	{
		self player_take_piece( pieceSpawn, is_archipelago );
	}
}
