...
#insert scripts\zm\perks\archi_perk_phdflopper.gsh;
...
function phd_flopper_func_init() 
{
	...
	WAIT_SERVER_FRAME;
	level thread archi_perk_utils::include_perk_in_random_rotation_delayed(PERK_PHDFLOPPER);
}
